...
const file_thoughts_proto_rawDesc = "" +
	"\n" +
	"\x0ethoughts.proto\x12\bthoughts\"\a\n" +
	"\x05Empty\"u\n" +
	...
	"\x05Users\x12$\n" +
	"\x05users\x18\x01 \x03(\v2\x0e.thoughts.UserR\x05users\"?\n" +
	...
	"\auser_id\x18\x01 \x01(\x05R\x06userId\x12\x12\n" +
	"\x04page\x18\x02 \x01(\x05R\x04page\x12\x14\n" +
	"\x05limit\x18\x03 \x01(\x05R\x05limit2\xa2\x03\n" +
	"\vUserService\x12?\n" +
	"\n" +
	"CreateUser\x12\x1b.thoughts.CreateUserRequest\x1a\x14.thoughts.Identifier\x120\n" +
	"\aGetUser\x12\x15.thoughts.UserRequest\x1a\x0e.thoughts.User\x12:\n" +
	"\n" +
...
var file_thoughts_proto_goTypes = []any{
	...
	(*CreateUserRequest)(nil), // 1: thoughts.CreateUserRequest
	(*Identifier)(nil),        // 2: thoughts.Identifier
...
var file_thoughts_proto_depIdxs = []int32{
	...
	1,  // 2: thoughts.UserService.CreateUser:input_type -> thoughts.CreateUserRequest
	3,  // 3: thoughts.UserService.GetUser:input_type -> thoughts.UserRequest
	5,  // 4: thoughts.UserService.UpdateUser:input_type -> thoughts.UpdateUserRequest
	6,  // 5: thoughts.UserService.GetFollowing:input_type -> thoughts.GetUsersRequest
	6,  // 6: thoughts.UserService.GetFollowers:input_type -> thoughts.GetUsersRequest
	3,  // 7: thoughts.UserService.FollowUser:input_type -> thoughts.UserRequest
	3,  // 8: thoughts.UserService.UnfollowUser:input_type -> thoughts.UserRequest
	...
	2,  // 22: thoughts.UserService.CreateUser:output_type -> thoughts.Identifier
	4,  // 23: thoughts.UserService.GetUser:output_type -> thoughts.User
	0,  // 24: thoughts.UserService.UpdateUser:output_type -> thoughts.Empty
	7,  // 25: thoughts.UserService.GetFollowing:output_type -> thoughts.Users
	7,  // 26: thoughts.UserService.GetFollowers:output_type -> thoughts.Users
	0,  // 27: thoughts.UserService.FollowUser:output_type -> thoughts.Empty
	0,  // 28: thoughts.UserService.UnfollowUser:output_type -> thoughts.Empty
	...
	0,  // 31: thoughts.AuthService.DeleteSession:output_type -> thoughts.Empty
	2,  // 32: thoughts.PostService.CreatePost:output_type -> thoughts.Identifier
