...
**Chirps** is a post-sharing application where users can create, browse,
...
```sh
git clone git@github.com:keshavbansal015/chirps.git
cd chirps
```
...
```sh
kubectl create namespace chirps
```
...
```sh
kubectl port-forward service/frontend 8080:8080 -n chirps
```
...
```sh
kubectl delete -f ./k8s -n chirps
```

Delete the namespace

```sh
kubectl delete namespace chirps
```
